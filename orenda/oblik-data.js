...
window.OBLIK_SEED = [
 {id:"b-pavuk-0923", type:"rent", costume:"Павук", client:"клієнт з Direct", city:"Харків",
  ...
  sum:200, dep:500, paid:true, depTaken:true, sent:true,
  note:"віддали 22.09, оренда 23.09, повертають 24.09. Застава 500 ₴ — домовились індивідуально, уже в нас."},
 {id:"b-batman-0927", type:"rent", costume:"Бетмен", client:"anastasia (Direct)", city:"Нова пошта",
  ...
  sum:200, dep:800, paid:true, sent:true, depTaken:false,
  note:"оренда оплачена, застава 800 ₴ — накладеним платежем, прийде за ТТН. Відправили 23.09, оренда в неділю 27.09, у понеділок 28.09 відправляють назад. Дві маски в комплекті."},
 {id:"b-rats-1101", type:"rent", costume:"Щур ×3", client:"бронь з Direct", city:"Харків",
  ...
  note:"оренда 750 ₴ уже оплачена. Три щури: віддаємо 31.10, оренда 01.11, повертають 02.11. Заставу беремо при видачі."}
];
